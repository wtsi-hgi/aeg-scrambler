...
class Coordinates:
    ...
    def convolve_step_function(self, config):
        ...
        self.data[("Enhancer_convolution_x")] = [np.empty(0, dtype = float)] * len(self.data)
        self.data[("Enhancer_convolution_y")] = [np.empty(0, dtype = float)] * len(self.data)
